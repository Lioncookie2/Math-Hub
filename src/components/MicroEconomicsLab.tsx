...
export const MicroEconomicsLab: React.FC = () => {
    ...
    const annotations = useMemo(() => {
        ...
        if (marketType === 'monopoly') {
            list.push({ x: calculationData.socY, y: 0, xref: 'x', yref: 'y', text: 'Qc', showarrow: true, arrowhead: 0, ax: 0, ay: -30, yshift: 10, font: { color: 'gray', size: 12, weight: 'normal' }, bgcolor: 'rgba(0,0,0,0.5)', borderpad: 4 });
        }
        return list;
